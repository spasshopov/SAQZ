...
public class CreateQuizQuestionActivity extends ActionBarActivity {
    ...
    public void saveQuestion(View v){
        ...
        class saveNewQuestion extends AsyncTask<Void, Void, Boolean> {
            ...
            protected Boolean doInBackground(Void... params) {
                ...
                if(db.init()){
                    try {
                        int qId = db.createQuizQuestion(questionText, user.id, quiz.id);
            ...
            protected void onPostExecute(Boolean result) {
                ...
                if(result){
                    Toast.makeText(getBaseContext(),
                            ...
                            .show();
                    Intent intent = new Intent(CreateQuizQuestionActivity.this, QuizOptionsActivity.class);
